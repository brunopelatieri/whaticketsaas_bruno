    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: mode === "light" ? "#8B5CF6" : "#FFFFFF" },
                quicktags: { main: mode === "light" ? "#8B5CF6" : "#8B5CF6" },
                sair: { main: mode === "light" ? "#8B5CF6" : "#1A1A1A" },
                vcard: { main: mode === "light" ? "#8B5CF6" : "#2D2D2D" },
                textPrimary: mode === "light" ? "#8B5CF6" : "#FFFFFF",
                borderPrimary: mode === "light" ? "#8B5CF6" : "#FFFFFF",
                ...
                fontecor: mode === "light" ? "#6D28D9" : "#FFFFFF",
                ...
                messageIcons: mode === "light" ? "#6B7280" : "#FFFFFF",
                inputBackground: mode === "light" ? "#FFFFFF" : "#1A1A1A",
                barraSuperior: mode === "light" ? "linear-gradient(to right, #8B5CF6, #A855F7, #C084FC)" : "#666",
